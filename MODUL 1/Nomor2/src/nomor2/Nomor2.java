...
public class Nomor2 {
    public static void main(String[] args) {
        ...
        */
        ...
        System.out.println("b. Jumlah hari Ijang harus bekerja" );
        System.out.println("   " +totalhari + " Hari");   
        
        //Nomor Dua C
        
        System.out.println("c. Potongan gaji Ijang dan gaji kotor yang diterima (pon)");
        System.out.println("   Potongan gaji Ijang " +f1+ " Pon");
        System.out.println("   Gaji kotor Ijang yang diterima " +f+ " Pon");
